...
(:
 ...
 :)
declare variable $config:default-template :="liditemplate.html";
...
declare variable $config:data-exclude :=(
    ...
    doc($config:data-root || "/place.xml")//tei:text,
    doc($config:data-root || "/people.xml")//tei:text,
    doc($config:data-root || "/bibl.xml")//tei:text,
...
(:~
 ...
 :)
declare variable $config:default-odd :="liditest.odd";
...
(:~
 ...
 :)
declare variable $config:odd-available :=("liditest.odd");
