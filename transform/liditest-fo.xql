    ...
    $input !         (
            ...
            return
                    ...
                    case element(figure) return
                        fo:block($config, ., ("tei-figure", css:map-rend-to-class(.)), .)
                    ...
                    case element(quote) return
                        fo:alternate($config, ., ("tei-quote1", css:map-rend-to-class(.)), ., ., id (substring-after(@source, '#'), doc("/db/apps/LiDi/data/bibl.xml")))
                    ...
                    case element(seg) return
                        if (@source) then
                            fo:link($config, ., ("tei-seg1", css:map-rend-to-class(.)), ., @source, map {"target": "_blank"})
                        else
                    ...
                    case element(term) return
                        fo:inline($config, ., ("tei-term", css:map-rend-to-class(.)), .)
