    ...
    $input !         (
            ...
            return
                    ...
                    case element(figure) return
                        html:block($config, ., ("tei-figure", css:map-rend-to-class(.)), .)
                    ...
                    case element(quote) return
                        printcss:alternate($config, ., ("tei-quote1", css:map-rend-to-class(.)), ., ., id (substring-after(@source, '#'), doc("/db/apps/LiDi/data/bibl.xml")))
                    ...
                    case element(seg) return
                        if (@source) then
                            html:link($config, ., ("tei-seg1", css:map-rend-to-class(.)), ., @source, "_blank", map {})
                        else
