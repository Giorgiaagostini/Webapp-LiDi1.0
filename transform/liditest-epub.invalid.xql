            ...
            return
                    ...
                    case element(author) return
                        if ($parameters?mode='commentary') then
                            ...
                            if (ancestor::teiHeader) then
                                ...
                                epub:block($config, ., ("tei-author2", css:map-rend-to-class(.)), id (substring-after(@ref, '#'), doc("/db/apps/LiDi/data/bibl.xml")))
                    ...
                    case element(bibl) return
                        if (ancestor::body) then
                            epub:alternate($config, ., ("tei-bibl", css:map-rend-to-class(.)), ., ., id (substring-after(@ref, '#'), doc("/db/apps/LiDi/data/bibl.xml")))
                        else
                            $config?apply($config, ./node())
                        ...
                        if ($parameters?mode='commentary') then
                            ...
                            if ($parameters?header='short') then
                                (
                                    ...
                                    (: Output abstract :)
                                    epub:block($config, ., ("tei-fileDesc5", "sample-description", css:map-rend-to-class(.)), //msContents/ab)
                                )
                    ...
                    case element(quote) return
                        epub:alternate($config, ., ("tei-quote1", css:map-rend-to-class(.)), ., ., id (substring-after(@ref, '#'), doc("/db/apps/LiDi/data/bibl.xml")))
                    ...
                    case element(place) return
                        (
                            epub:block($config, ., ("tei-place1", css:map-rend-to-class(.)), placeName),
